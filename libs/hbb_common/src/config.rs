...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("br.com.infcamp".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("InfRemote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["177.7.53.80"];
pub const RS_PUB_KEY: &str = "4zuymD6dDGGsNeF5Pl2gn3MZftUatErp3DGkfJnBDSY=";
